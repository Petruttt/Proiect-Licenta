    ...
    <div className='p-3 md:mx-auto'>
        ...
        <div className='flex flex-col w-full gap-4 p-3 rounded-md shadow-md dark:bg-slate-800 md:w-72'>
            <div className='flex justify-between'>
                ...
                <HiAnnotation className='p-3 text-5xl text-white bg-purple-600 rounded-full shadow-lg'/>
            </div>
            <div className='flex gap-2 text-sm'>
                    <span className='flex items-center text-green-500'>
                        <HiArrowNarrowUp />
        ...
        <div className='flex flex-col w-full gap-4 p-3 rounded-md shadow-md dark:bg-slate-800 md:w-72'>
            <div className='flex justify-between'>
                ...
                <HiDocumentText className='p-3 text-5xl text-white bg-green-600 rounded-full shadow-lg'/>
            </div>
            <div className='flex gap-2 text-sm'>
                    <span className='flex items-center text-green-500'>
                        <HiArrowNarrowUp />
